import './Template2.css' // new theme
    ...
    <div className="template2 border rounded mx-auto my-4 px-sm-4 py-3 w-100">
      ...
      <div className="row mb-4">
        <div className="col-md-6 mb-3 mb-md-0 text-start">
          ...
          <h2 className="mb-1 template2-company-title">{data.companyName}</h2>
          <p className="mb-1">{data.company}</p>
          <p className="mb-0">Phone: {data.companyPhone}</p>
        </div>
        <div className="col-md-6 text-start text-md-end">
          <h1 className="mb-2 template2-invoice-title">Invoice</h1>
      ...
      <hr className="my-3 template2-blue-border" />

      {/* Billing Section */}
      <div className="row g-3 mb-4">
        {data.shippingName && data.shippingPhone && data.shippingAddress && (
          <div className="col-md-6">
            <div className="p-3 rounded h-100 template2-billing-box text-start">
              <h3 className="mb-2 template2-billing-title">Shipped To</h3>
        ...
        <div className="col-md-6">
          <div className="p-3 rounded h-100 template2-billing-box text-start">
            <h3 className="mb-2 template2-billing-title">Billed To</h3>
      ...
      {(data.accountName || data.accountNumber || data.accountsortCode) && (
        <div className="row mt-4">
          <div className="col-md-8 text-start">
            <h3 className="mb-2 template2-billing-title">Bank Account Details</h3>
            ...
            {data.accountsortCode && <p className="mb-0"><strong>sort/Branch Code:</strong> {data.accountsortCode}</p>}
          </div>
        </div>
      )}
      ...
      {data.notes && (
        <div className="row mt-4">
          <div className="col-md-8 text-start">
            <h3 className="mb-2 template2-billing-title">Remarks</h3>
